...
function App() {
  ...
  useEffect(() => {
    if (role) {
      const preloadComponents = async () => {
        try {
          console.info(`Preloading components for role: ${role}`);
          switch (role) {
            case 'superadmin':
              // Load components sequentially to prevent overwhelming the browser
              console.info('Loading SuperAdmin components...');
              ...
              console.info('SuperAdmin components loaded successfully');
              break;
            case 'admin':
              console.info('Loading Admin components...');
              ...
              break;
            case 'user':
              console.info('Loading User components...');
  ...
  useEffect(() => {
    if (user) {
      ...
      console.info(`Page view: ${location.pathname} by ${user.email}`);
    }
