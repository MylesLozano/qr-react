      ...
      <div className="w-full md:w-64 bg-blue-900 text-white p-5 md:h-screen">
        ...
        <nav>
          <ul className="space-y-4">
            <li>
              <Link to="/inventory" className="block hover:bg-blue-700 p-2 rounded">
                Inventory
              </Link>
            </li>
            {role === "admin" ? (
              <>
                <li>
                  <Link to="/requests" className="block hover:bg-blue-700 p-2 rounded">
                    Requests
                  </Link>
                </li>
                <li>
              ...
              <li>
                <Link to="/my-requests" className="block hover:bg-blue-700 p-2 rounded">
                  My Requests
                </Link>
              </li>
            )}
