  ...
  return (
    <ErrorBoundary>
      <div className={`min-h-screen flex ${themeStyles.container}`}>
        ...
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 bg-blue-500 text-white p-2 rounded z-50"
        >
          Skip to main content
        </a>
        {/* Sidebar Navigation for all roles */}{' '}
        <nav
          className={`${themeStyles.nav} w-[280px] flex-shrink-0 
        ...
        {/* Hamburger menu button - shown only on mobile for all roles */}
        {isMobile && (
          <button
            ref={menuButtonRef}
