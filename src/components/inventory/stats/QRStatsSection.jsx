    ...
    <div className={`flex-1 p-4 rounded-lg ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="flex-1 grid grid-cols-3 gap-3 items-center">
          <div className={`p-3 rounded-lg text-center ${isDarkMode ? 'bg-blue-900/30' : 'bg-blue-100'}`}>
          ...
          <div className={`p-3 rounded-lg text-center ${isDarkMode ? 'bg-green-900/30' : 'bg-green-100'}`}>
