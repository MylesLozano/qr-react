...
function SessionTimeout({
  ...
  return (
    <div
      ...
      `}
    >
      <h3 id="timeout-title" className="text-lg font-semibold mb-2">
      ...
      <div className="flex gap-2">
        <Button onClick={resetTimer} color="blue" size="sm" aria-label="Stay logged in">
          Stay Logged In
        </Button>
        <Button onClick={handleTimeout} color="gray" size="sm" aria-label="Log out now">
          Log Out
        </Button>
      </div>
    </div>
